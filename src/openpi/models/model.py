...
class Observation(Generic[ArrayT]):
    ...
    # APSG (Action-Projected Self-Grounding) optional fields, populated by
    # the `APSGProjection` data transform. All default to None and are
    # ignored unless the model has APSG enabled.
    apsg_target_uv: at.Float[ArrayT, "*b 2"] | None = None
